...
import pinkflowers from '../images/pinkflowers.jpg'
  ...
  return (
    <div className='w-full flex flex-col space-y-6'>
      ...
      <section className='flex flex-col md:flex-row self-center max-md:space-y-6 rounded-3xl overflow-x-hidden'>
        <Cards image={pinkflowers} alt='Pink flower' className='lg:m-5 lg:w-[30vw] lg:h-96 md:w-[30vw] md:h-52 w-[500px] max-sm:w-[450px]' />
        <Cards image={purpleflowers} alt='purple flowers' className='lg:m-5 lg:w-[30vw] lg:h-96 md:w-[30vw] md:h-52 w-[500px] max-sm:w-[450px]' />
        <Cards image={orangeroses} alt='orange roses' className='lg:m-5 lg:w-[30vw] lg:h-96 md:w-[30vw] md:h-52 w-[500px] max-sm:w-[450px]' />
      </section>
      ...
      <Cards image={tulips} alt='blaljknjf' className='self-center w-[600px] h-[350px] max-sm:w-[450px] max-sm:h-[300px]' />
